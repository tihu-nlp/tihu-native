...
export class SpeakRequest extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: SpeakRequest): SpeakRequest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SpeakRequest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SpeakRequest;
    static deserializeBinaryFromReader(message: SpeakRequest, reader: jspb.BinaryReader): SpeakRequest;
}
...
export class SpeakReply extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: SpeakReply): SpeakReply.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SpeakReply, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SpeakReply;
    static deserializeBinaryFromReader(message: SpeakReply, reader: jspb.BinaryReader): SpeakReply;
}
