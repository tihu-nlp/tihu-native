...
interface ITihuService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  speak: ITihuService_ISpeak
  version: ITihuService_IVersion
}

interface ITihuService_ISpeak
  extends grpc.MethodDefinition<tihu_pb.SpeakRequest, tihu_pb.SpeakReply> {
...
interface ITihuService_IVersion
  extends grpc.MethodDefinition<tihu_pb.Empty, tihu_pb.VersionReply> {
...
export interface ITihuServer {
  speak: grpc.handleServerStreamingCall<
    tihu_pb.SpeakRequest,
    tihu_pb.SpeakReply
  >
...
export interface ITihuClient {
  speak(
    request: tihu_pb.SpeakRequest,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<tihu_pb.SpeakReply>
  speak(
    request: tihu_pb.SpeakRequest,
  ...
  version(
    request: tihu_pb.Empty,
    callback: (
      error: grpc.ServiceError | null,
      response: tihu_pb.VersionReply
    ) => void
